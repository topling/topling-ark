...
size_t SuffixCoutableNestTrieDAWG<NestTrie>::suffix_cnt(size_t node_id)
const {
	return m_trie->dawg_suffix_cnt(node_id);
}
...
#if defined(NLT_ALWAYS_HAS_GLOBAL_COMMON_PREFIX) // this is for MyTopling
