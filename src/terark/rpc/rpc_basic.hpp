...
#define TERARK_RPC_HELLO "terark rpc hello"
...
#define TERARK_RPC_GEN_full_mf_name(ClassName)	\
...
class TERARK_DLL_EXPORT rpc_exception : public std::exception
{
protected:
	std::string m_message;
public:
	explicit rpc_exception(const char* szMsg = "terark::rpc::rpc_exception");
...
struct TERARK_DLL_EXPORT RoCreator // : public RefCounter
{
	create_fun_t create;
	unsigned     classID;
...
class TERARK_DLL_EXPORT remote_object : public RefCounter
{
public:
...
class TERARK_DLL_EXPORT GlobaleScope : public remote_object
{
public:
	typedef GlobaleScope SFINAE_gs_self_t; // for SFINAE
};
typedef boost::intrusive_ptr<GlobaleScope> GlobaleScopePtr;
class TERARK_DLL_EXPORT SessionScope : public remote_object
{
public:
...
class TERARK_DLL_EXPORT ObjectFactoryBase
{
protected:
