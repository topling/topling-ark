...
//  different popcount instructions in different headers
  ...
  inline int fast_popcount32(unsigned int v) {
	...
	inline int terark_bsr_u64(unsigned __int64 x) {
	...
	inline int terark_bsr_u32(unsigned long x) {
		unsigned long Index = 0;
...
//  #define TERARK_BIT_TEST_USE_INTRINSIC
    #if TERARK_WORD_BITS == 64
	  BOOST_STATIC_ASSERT(sizeof(long) == 8); // LP model
	  inline bool terark_bit_test(const long* a, long i) { return _bittest64(reinterpret_cast<const __int64*>(a), i) ? 1 : 0; }
	  inline bool terark_bit_test(const long long* a, long i) { return _bittest64(reinterpret_cast<const __int64*>(a), i) ? 1 : 0; }
	  inline bool terark_bit_test(const unsigned long* a, long i) { return _bittest64(reinterpret_cast<const __int64*>(a), i) ? 1 : 0; }
	  inline bool terark_bit_test(const unsigned long long* a, long i) { return _bittest64(reinterpret_cast<const __int64*>(a), i) ? 1 : 0; }

	  inline void terark_bit_set0(long* a, long i) { _bittestandreset64(reinterpret_cast<__int64*>(a), i); }
	  inline void terark_bit_set0(long long* a, long i) { _bittestandreset64(reinterpret_cast<__int64*>(a), i); }
	  inline void terark_bit_set0(unsigned long* a, long i) { _bittestandreset64(reinterpret_cast<__int64*>(a), i); }
	  inline void terark_bit_set0(unsigned long long* a, long i) { _bittestandreset64(reinterpret_cast<__int64*>(a), i); }

	  inline void terark_bit_set1(long* a, long i) { _bittestandset64(reinterpret_cast<__int64*>(a), i); }
	  inline void terark_bit_set1(long long* a, long i) { _bittestandset64(reinterpret_cast<__int64*>(a), i); }
	  inline void terark_bit_set1(unsigned long* a, long i) { _bittestandset64(reinterpret_cast<__int64*>(a), i); }
	  inline void terark_bit_set1(unsigned long long* a, long i) { _bittestandset64(reinterpret_cast<__int64*>(a), i); }
    #else
	  inline bool terark_bit_test(const int* a, long i) { return _bittest(a, i) ? 1 : 0; }
	  inline bool terark_bit_test(const unsigned int* a, long i) { return _bittest(reinterpret_cast<const int*>(a), i) ? 1 : 0; }
	  inline void terark_bit_set0(int* a, long i) { _bittestandreset(a, i); }
	  inline void terark_bit_set0(unsigned int* a, long i) { _bittestandreset(reinterpret_cast<int*>(a), i); }
	  inline void terark_bit_set1(int* a, long i) { _bittestandset(a, i); }
	  inline void terark_bit_set1(unsigned int* a, long i) { _bittestandset(reinterpret_cast<int*>(a), i); }
    #endif
#elif defined(_MSC_VER) || defined(__INTEL_COMPILER)
    #define TERARK_BIT_TEST_USE_INTRINSIC
    #if TERARK_WORD_BITS == 64
	  inline bool terark_bit_test(const __int64* a, __int64 i) { return _bittest64(a, i) ? 1 : 0; }
	  inline bool terark_bit_test(const unsigned __int64* a, __int64 i) { return _bittest64(reinterpret_cast<const __int64*>(a), i) ? 1 : 0; }
	  inline void terark_bit_set0(__int64* a, __int64 i) { _bittestandreset64(a, i); }
	  inline void terark_bit_set0(unsigned __int64* a, __int64 i) { _bittestandreset64(reinterpret_cast<__int64*>(a), i); }
	  inline void terark_bit_set1(__int64* a, __int64 i) { _bittestandset64(a, i); }
	  inline void terark_bit_set1(unsigned __int64* a, __int64 i) { _bittestandset64(reinterpret_cast<__int64*>(a), i); }
    #endif
	inline bool terark_bit_test(const long* a, long i) { return _bittest(a, i) ? 1 : 0; }
	inline bool terark_bit_test(const unsigned long* a, long i) { return _bittest(reinterpret_cast<const long*>(a), i) ? 1 : 0; }
	inline bool terark_bit_test(const int* a, long i) { return _bittest(reinterpret_cast<const long*>(a), i) ? 1 : 0; }
	inline bool terark_bit_test(const unsigned* a, long i) { return _bittest(reinterpret_cast<const long*>(a), i) ? 1 : 0; }

	inline void terark_bit_set0(int* a, long i) { _bittestandreset(reinterpret_cast<long*>(a), i); }
	inline void terark_bit_set0(unsigned* a, long i) { _bittestandreset(reinterpret_cast<long*>(a), i); }
	inline void terark_bit_set1(int* a, long i) { _bittestandset(reinterpret_cast<long*>(a), i); }
	inline void terark_bit_set1(unsigned* a, long i) { _bittestandset(reinterpret_cast<long*>(a), i); }
#endif

#if !defined(TERARK_BIT_TEST_USE_INTRINSIC)
template<class Uint>
inline bool terark_bit_test(const Uint* a, size_t i) {
	return a[i/(sizeof(Uint)*8)] & (Uint(1)<<i%(sizeof(Uint)*8)) ? 1 : 0;
}
template<class Uint>
inline void terark_bit_set0(Uint* a, size_t i) {
	a[i/(sizeof(Uint)*8)] &= ~(Uint(1) << i % (sizeof(Uint) * 8));
}
template<class Uint>
inline void terark_bit_set1(Uint* a, size_t i) {
	a[i/(sizeof(Uint)*8)] |= (Uint(1) << i % (sizeof(Uint) * 8));
}
#endif
...
#if defined(__BMI2__)
inline int fast_popcount_trail(unsigned int x, unsigned int n) { return fast_popcount32(_bzhi_u32(x, n)); }
#else
inline int fast_popcount_trail(unsigned int x, unsigned int n) { return fast_popcount32(x & ~(unsigned(-1) << n)); }
#endif

#if defined(__BMI2__) && TERARK_WORD_BITS >= 64
inline long long fast_popcount_trail(unsigned long long x, unsigned long long n) { return fast_popcount64(_bzhi_u64(x, unsigned(n))); }
#else
inline TERARK_IF_WORD_BITS_64(long long, int)
