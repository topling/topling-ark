...
#pragma pack(pop)
    ...
    static inline size_t select0_upper_bound_line(const index_t* sel0, const RankCache512*, size_t id) noexcept;
    static inline size_t select1_upper_bound_line(const index_t* sel1, const RankCache512*, size_t id) noexcept;
public:
...
(const index_t* sel0, const RankCache512* rankCache, size_t Rank0)
noexcept {
...
noexcept {
    size_t lo = select0_upper_bound_line(sel0, rankCache, Rank0);
...
(const index_t* sel1, const RankCache512* rankCache, size_t Rank1)
noexcept {
...
noexcept {
    size_t lo = select1_upper_bound_line(sel1, rankCache, Rank1);
